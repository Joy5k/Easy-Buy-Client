...
const AboutUs = () => {
    ...
    <div className='w-1/2'>
      ...
      <p className="py-6 text-gray-200 text-xl">EasyBuy is a phone financing service. Buy Any Smartphone and Pay Later with EasyBuy Mobile Device Financing Platform. With this platform, users get to purchase mobile phones</p>
    </div>
  </div>
</div>
        </div>
